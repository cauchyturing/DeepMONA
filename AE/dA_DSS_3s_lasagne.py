# -*- coding: utf-8 -*-
"""
Created on Wed Jun 22 10:20:46 2016
...
num_epochs=5000 #5000 20000
noise_factor = 0.3
length = 98 
height = 39 #39, 193， 1024
lr = .1 #0.001 0.1
hid = 7
plot_extent = 100

savename = toneorchord+'_STFT_dA_node'+str(hid)
...
#f = '/media/stephen/BaoBao/Research/nUS_7-dES_3000ms-nOES_1-fBW_2000mHz-tBW_31ms-amp_94dB-pOl_94-noNoise_tone'
...
#        #W=W)
#
#da1 = lasagne.layers.DenseLayer(
#        da, num_units=hid,
#        nonlinearity=lasagne.nonlinearities.rectify,
#        W=lasagne.init.GlorotUniform())
#
#da2 = lasagne.layers.DenseLayer(
#        Input, num_units=hid,
#        nonlinearity=lasagne.nonlinearities.rectify,
#        W=lasagne.init.GlorotUniform())
#
#l2 = lasagne.layers.DenseLayer(
#        da2, num_units=length*height,
#        nonlinearity=lasagne.nonlinearities.sigmoid, 
#        #W=l1.W.T)
#        W=lasagne.init.GlorotUniform())
...
#updates = lasagne.updates.apply_momentum(updates, params=None, momentum=0.1)
